  ...
  return (
    <Layout>
      <div className="text-center animate-fade-in">
        ...
        {/* Pass Header */}
        <div className="bg-indigo-600 text-white py-2 px-4 rounded-full inline-block text-xs font-bold mb-4 tracking-wide shadow-md">
          OFFICIAL FEST PASS
        </div>
        ...
        {/* Registration Number */}
        <p className="text-indigo-600 font-mono font-bold text-md mt-1">
